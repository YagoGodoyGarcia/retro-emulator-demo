...
// vêm de lib/platforms.js agora — fonte única, não repete a lista aqui.
// Continua separado de LAYOUTS porque "segaMD6" não é um console, é uma
// variante de controle do segaMD: juntar os dois num Object.keys só faria
// um core inválido pra "segaMD6" quebrar o upload silenciosamente.
const CORES = require("./platforms").CORES;
