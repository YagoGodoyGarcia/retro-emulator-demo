...
/**
 * Edição de um jogo já cadastrado — só os metadados de texto (título, gênero,
 * temas). Arquivo e console não mudam por aqui: trocar o core invalidaria a
 * extensão da ROM já enviada, e trocar o arquivo é, na prática, um novo
 * upload (apagar e adicionar de novo).
 */
function buildGameUpdate(fields) {
