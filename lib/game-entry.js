...
// a lista canônica — evita duas listas que podem desalinhar). Note que isso é
// VIRTUAL_GAMEPAD.CORES, não Object.keys(VIRTUAL_GAMEPAD): esse objeto também
// tem variantes de controle (ex. "segaMD6") que não são consoles válidos.
const CORES = VIRTUAL_GAMEPAD.CORES;
 ...
 * temas) e, opcionalmente, uma capa nova. ROM e console não mudam por aqui:
 * trocar o core invalidaria a extensão da ROM já enviada, e trocar o arquivo
 * da ROM é, na prática, um novo upload (apagar e adicionar de novo).
 *
